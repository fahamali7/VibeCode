...
export async function POST(request: NextRequest){
    ...
    if(user.plan != "pro"){
        return Response.json({message: "Upgrade the plan"}, {status: 403})
          ...
          done_improving: { autoApprove: true },
                ...
                try {
                    ...
                    agent.subscribe((event) =>{
                       ...
                       // triggers everytime a tool called
